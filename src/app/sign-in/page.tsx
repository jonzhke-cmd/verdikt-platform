    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-verdikt-card border border-verdikt-border rounded-2xl p-8 shadow-2xl">
          {/* Google Sign In */}
          <button className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-verdikt-border text-white font-medium hover:bg-white/5 hover:border-gray-500 transition-all mb-6">
