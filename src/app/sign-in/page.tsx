      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-verdikt-card border border-verdikt-border rounded-2xl p-8 shadow-2xl">
          ...
          <button
            onClick={() => {
              localStorage.setItem('verdikt_authed', 'true')
              localStorage.setItem('verdikt_user_email', 'demo@example.com')
              localStorage.setItem('verdikt_user_name', 'Demo User')
              localStorage.setItem('verdikt_user_balance', '1000.00')
              router.push('/portfolio')
            }}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-verdikt-border text-white font-medium hover:bg-white/5 hover:border-gray-500 transition-all mb-6"
          >
